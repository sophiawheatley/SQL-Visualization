...
- SQL syntax: We choose to adopt and adapt the SQL syntax for our visualization language. This because, the SQL syntax is well known to both developers as well as non-developers (fast adoption), and because, the SQL syntax allows for advanced data querying (see following bullet point)
